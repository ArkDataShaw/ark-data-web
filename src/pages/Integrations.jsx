      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filtered.map((integration, idx) => (
            <div key={idx} className="bg-gray-50 rounded-lg p-8 hover:shadow-lg transition">
              <h3 className="text-xl font-bold text-gray-900 mb-2">{integration.name}</h3>
              <p className="text-gray-600 text-sm mb-6">{integration.desc}</p>

              <div className="mb-6 space-y-3">
                <div>
                  <p className="text-xs font-semibold text-gray-500 uppercase mb-2">What Syncs</p>
                  <div className="flex flex-wrap gap-2">
                    {integration.syncs.map((sync, sidx) => (
                      <span key={sidx} className="bg-white px-2 py-1 rounded text-xs text-gray-700 border border-gray-200">
                        {sync}
                      </span>
                    ))}
                  </div>
                ...
                <div>
                  <p className="text-xs font-semibold text-gray-500 uppercase">Auth Type</p>
                  <p className="text-sm text-gray-700">{integration.auth}</p>
                </div>
              </div>
