    ...
    <div className="bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32 text-center">
        ...
        <div className="flex items-center justify-center gap-4 mb-12">
          ...
          <span className={billingCycle === 'annual' ? 'text-gray-900 font-semibold' : 'text-gray-600'}>
              ...
              return (
                <div
                  ...
                  className={`rounded-xl p-8 transition-all ${
                    plan.highlighted
                      ? 'border-2 border-blue-600 ring-4 ring-blue-100 bg-gradient-to-br from-blue-50 to-white'
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm mb-6">{plan.who_its_for}</p>

                  <div className="mb-6">
                    <p className="text-4xl font-bold text-gray-900">
                      ${price || 'Contact'}
                    </p>
                    {price > 0 && <p className="text-sm text-gray-600 mt-1">/month{billingCycle === 'annual' && ', billed annually'}</p>}
                  </div>

                  <button className={`w-full py-3 px-4 rounded-lg font-semibold transition mb-8 ${
                    plan.highlighted
                      ? 'bg-blue-600 text-white hover:bg-blue-700'
                      : 'border border-gray-300 text-gray-900 hover:border-blue-600 hover:text-blue-600'
                  }`}>
              ...
              <tbody>
                {features.map((feature, idx) => (
                  <tr key={idx} className="border-b border-gray-200 hover:bg-white transition">
                    <td className="py-4 px-4 text-gray-700 font-medium">{feature}</td>
