...
const coreServices = [
  {
    ...
    features: [
      ...
      { title: 'Identity Resolution', desc: 'Match sessions to real individuals and companies via our licensed, continuously validated identity graph.' },
      { title: '650+ Data Points', desc: 'Identity, demographics, contact, professional, company, and social data auto-appended to every resolved visitor.' },
...
const supportingServices = [
  ...
  { name: 'CRM Enrichment', icon: '⚙️', desc: 'Enrich your existing CRM records with 650+ data points from our identity graph - filling gaps in contact, company, and demographic data.', available: 'Growth+' },
  { name: 'Audience Building for Ads', icon: '🎯', desc: 'Push enriched audiences to Meta, Google Ads, and DV360 for ad targeting, or route to any platform via HighLevel, Klaviyo, Clay, HubSpot, or custom webhook.', available: 'Growth+' },
