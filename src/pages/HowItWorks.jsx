        ...
        <div className="sc">
          <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
            {[
              ...
              { num: '03', title: 'Ark Identifies & Enriches', desc: 'Every session is resolved against our licensed, validated identity graph - then enriched with 650+ data points of contact, demographic, and company data.', time: 'Real-time', details: ['40–60% visitor resolution rate', '650+ data points appended', '~72% of resolved visitors include company data', 'ICP matching configured at onboarding'] },
              { num: '04', title: 'Leads Flow to Your Stack', desc: 'Enriched leads are routed to your CRM, triggered into outbound sequences, and pushed to your marketing tools - all automatically.', time: 'Instant', details: ['CRM record creation or update', 'Sequence/cadence trigger', 'Meta, Google Ads & DV360 audience sync', 'Webhook notifications'] },
            ].map((step, i) => (
