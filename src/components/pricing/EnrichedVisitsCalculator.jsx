    ...
    <BarChart data={[
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '16px' }}>
        ...
        <div style={{ background: 'rgba(34,197,94,0.06)', border: '1px solid rgba(34,197,94,0.25)', borderRadius: '12px', padding: '24px 28px' }}>
          ...
          {/* Bottom CTA */}
          <div style={{ marginTop: '48px', display: 'flex', justifyContent: 'center', borderTop: '1px solid rgba(34,197,94,0.15)', paddingTop: '36px' }}>
            <div style={{ maxWidth: '520px', textAlign: 'center' }}>
              ...
              <p style={{ color: '#3ab870', fontSize: '15px', marginTop: '12px' }}>No credit card required · Cancel anytime</p>
            </div>
          </div>
          </div>
          </div>
